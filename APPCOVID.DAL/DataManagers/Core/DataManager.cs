...
namespace APPCOVID.DAL.DataManagers.Core
{
    ...
    {
        private readonly string _connectionString = @"Server=dashdb-txn-sbox-yp-lon02-06.services.eu-gb.bluemix.net:50000;DATABASE=BLUDB;UID=fbf33999;PWD=4n7-3s68ctrm92sv;";
